...
来源：[`packages/codewhale/constitution/src/index.ts:42`](../packages/codewhale/constitution/src/index.ts)

<a id="deepseek-aidsh-codewhale-fleet"></a>

## `@deepseek-ai/dsh-codewhale-fleet`

需要：`llm` · `agentDefaultModel`
...
来源：[`packages/codewhale/fleet/src/index.ts:50`](../packages/codewhale/fleet/src/index.ts)
...
来源：[`packages/codewhale/snapshot/src/index.ts:33`](../packages/codewhale/snapshot/src/index.ts)
...
来源：[`packages/llm/llm-opencode-go/src/index.ts:73`](../packages/llm/llm-opencode-go/src/index.ts)
...
需要：`agents` · `sessions` · `commands` · `userInteraction` · `tools` · `llm` · `systemPrompt` · `tokenMeter` · `tuiPrompt`
...
- `@deepseek-ai/dsh-rheostat` — 需要 `tools` · `systemPrompt`（[`packages/context/rheostat/src/index.ts`](../packages/context/rheostat/src/index.ts)）
