/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-codewhale`.
 * @module @deepseek-ai/dsh-codewhale/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-codewhale'

/** Cordis companion plugin name. */
export const name = 'codewhale-bundle-invariant'
